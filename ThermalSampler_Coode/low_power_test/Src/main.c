...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_InitTypeDef gp = ZERO_ARRAY;
  gp.Pin = RADIO_SW_Pin | LED1_Pin;
  gp.Mode = GPIO_MODE_OUTPUT_PP;
  gp.Pull = GPIO_NOPULL;
  gp.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RADIO_SW_GPIO_Port, &gp);
  HAL_GPIO_WritePin(RADIO_SW_GPIO_Port, RADIO_SW_Pin | LED1_Pin, GPIO_PIN_SET);
  gp.Pin = SENSOR_SW_Pin;
  HAL_GPIO_Init(SENSOR_SW_GPIO_Port, &gp);
  HAL_GPIO_WritePin(SENSOR_SW_GPIO_Port, SENSOR_SW_Pin, GPIO_PIN_SET);
}
