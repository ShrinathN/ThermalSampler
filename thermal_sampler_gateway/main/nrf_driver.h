...
//lines macros
#define NRF_DELAY(X) vTaskDelay(X / portTICK_RATE_MS)
#define NRF_CS_LOW gpio_set_level(NRF_CSN_PIN, 0)
#define NRF_CS_HIGH gpio_set_level(NRF_CSN_PIN, 1)
#define NRF_CE_LOW gpio_set_level(NRF_CE_PIN, 0)
#define NRF_CE_HIGH gpio_set_level(NRF_CE_PIN, 1)
